class site::my_yum {
  ...
  $lsbmajdistrelease = "6"
    ...
    file { "RPM-GPG-KEY-OSG":
        ...
        source => "puppet:///modules/site/rpm-gpg/RPM-GPG-KEY-OSG",
        ensure => present,
...
#           mirrorlist => "http://repo.grid.iu.edu/mirror/3.0/el$lsbmajdistrelease/osg-release/\$basearch",
            baseurl => "http://repo.grid.iu.edu/3.0/el$lsbmajdistrelease/osg-release/\$basearch",
            enabled => 1,
            gpgcheck => 1,
...
#           mirrorlist => "http://repo.grid.iu.edu/mirror/3.0/el$lsbmajdistrelease/osg-upcoming-release/\$basearch",
            baseurl => "http://repo.grid.iu.edu/3.0/el$lsbmajdistrelease/osg-upcoming-release/\$basearch",
            enabled => 1,
            gpgcheck => 1,
            gpgkey => 'file:///etc/pki/rpm-gpg/RPM-GPG-KEY-OSG',
            failovermethod => 'priority',
    ...
    #       baseurl => "http://repo.grid.iu.edu/3.0/el$lsbmajdistrelease/osg-upcoming-release/source/SRPMS",
            baseurl => "http://repo.grid.iu.edu/3.0/el$lsbmajdistrelease/osg-upcoming-release/source/SRPMS",
            enabled => 0,
            gpgcheck => 1,
            gpgkey => 'file:///etc/pki/rpm-gpg/RPM-GPG-KEY-OSG',
    ...
    #       baseurl => "http://repo.grid.iu.edu/3.0/el$lsbmajdistrelease/osg-upcoming-release/\$basearch/debug",
            baseurl => "http://repo.grid.iu.edu/3.0/el$lsbmajdistrelease/osg-upcoming-release/\$basearch/debug",
            enabled => 0,
            gpgcheck => 1,
            gpgkey => 'file:///etc/pki/rpm-gpg/RPM-GPG-KEY-OSG',
 ...
 #        mirrorlist => "http://repo.grid.iu.edu/mirror/3.0/el$lsbmajdistrelease/osg-testing/\$basearch",
            baseurl => "http://repo.grid.iu.edu/3.0/el$lsbmajdistrelease/osg-testing/\$basearch",
         enabled => 0,
         gpgcheck => 1,
         gpgkey => 'file:///etc/pki/rpm-gpg/RPM-GPG-KEY-OSG',
         failovermethod => 'priority',
 ...
 #        mirrorlist => "http://repo.grid.iu.edu/mirror/3.0/el$lsbmajdistrelease/osg-testing/source/SRPMS",
            baseurl => "http://repo.grid.iu.edu/3.0/el$lsbmajdistrelease/osg-testing/source/SRPMS",
         enabled => 0,
         gpgcheck => 1,
         gpgkey => 'file:///etc/pki/rpm-gpg/RPM-GPG-KEY-OSG',
         failovermethod => 'priority',
 ...
 #        mirrorlist => "http://repo.grid.iu.edu/mirror/3.0/el$lsbmajdistrelease/osg-testing/\$basearch/debug",
            baseurl => "http://repo.grid.iu.edu/3.0/el$lsbmajdistrelease/osg-testing/\$basearch/debug",
         enabled => 0,
         gpgcheck => 1,
         gpgkey => 'file:///etc/pki/rpm-gpg/RPM-GPG-KEY-OSG',
         failovermethod => 'priority',
 ...
 #        mirrorlist => "http://repo.grid.iu.edu/mirror/3.0/el$lsbmajdistrelease/osg-upcoming-testing/\$basearch",
            baseurl => "http://repo.grid.iu.edu/3.0/el$lsbmajdistrelease/osg-upcoming-testing/\$basearch",
         enabled => 0,
         gpgcheck => 1,
         gpgkey => 'file:///etc/pki/rpm-gpg/RPM-GPG-KEY-OSG',
         failovermethod => 'priority',
 ...
 #        mirrorlist => "http://repo.grid.iu.edu/mirror/3.0/el$lsbmajdistrelease/osg-upcoming-testing/source/SRPMS",
            baseurl => "http://repo.grid.iu.edu/3.0/el$lsbmajdistrelease/osg-upcoming-testing/source/SRPMS",
         enabled => 0,
         gpgcheck => 1,
         gpgkey => 'file:///etc/pki/rpm-gpg/RPM-GPG-KEY-OSG',
         failovermethod => 'priority',
 ...
 #        mirrorlist => "http://repo.grid.iu.edu/mirror/3.0/el$lsbmajdistrelease/osg-upcoming-testing/\$basearch/debug",
            baseurl => "http://repo.grid.iu.edu/3.0/el$lsbmajdistrelease/osg-upcoming-testing/\$basearch/debug",
         enabled => 0,
         gpgcheck => 1,
         gpgkey => 'file:///etc/pki/rpm-gpg/RPM-GPG-KEY-OSG',
         failovermethod => 'priority',
  ...
  #       mirrorlist => "http://repo.grid.iu.edu/mirror/3.0/el$lsbmajdistrelease/osg-development/\$basearch",
            baseurl => "http://repo.grid.iu.edu/3.0/el$lsbmajdistrelease/osg-development/\$basearch",
         enabled => 0,
         gpgcheck => 1,
         gpgkey => 'file:///etc/pki/rpm-gpg/RPM-GPG-KEY-OSG',
         failovermethod => 'priority',
  ...
  #       mirrorlist => "http://repo.grid.iu.edu/mirror/3.0/el$lsbmajdistrelease/osg-development/source/SRPMS",
            baseurl => "http://repo.grid.iu.edu/3.0/el$lsbmajdistrelease/osg-development/source/SRPMS",
         enabled => 0,
         gpgcheck => 1,
         gpgkey => 'file:///etc/pki/rpm-gpg/RPM-GPG-KEY-OSG',
         failovermethod => 'priority',
  ...
  #       mirrorlist => "http://repo.grid.iu.edu/mirror/3.0/el$lsbmajdistrelease/osg-development/\basearch/debug",
            baseurl => "http://repo.grid.iu.edu/3.0/el$lsbmajdistrelease/osg-development/\$basearch/debug",
         enabled => 0,
         gpgcheck => 1,
         gpgkey => 'file:///etc/pki/rpm-gpg/RPM-GPG-KEY-OSG',
         failovermethod => 'priority',
  ...
  #       mirrorlist => "http://repo.grid.iu.edu/mirror/3.0/el$lsbmajdistrelease/osg-upcoming-development/\$basearch",
            baseurl => "http://repo.grid.iu.edu/3.0/el$lsbmajdistrelease/osg-upcoming-development/\$basearch",
         enabled => 0,
         gpgcheck => 1,
         gpgkey => 'file:///etc/pki/rpm-gpg/RPM-GPG-KEY-OSG',
         failovermethod => 'priority',
  ...
  #       mirrorlist => "http://repo.grid.iu.edu/mirror/3.0/el$lsbmajdistrelease/osg-upcoming-development/source/SRPMS",
            baseurl => "http://repo.grid.iu.edu/3.0/el$lsbmajdistrelease/osg-upcoming-development/source/SRPMS",
         enabled => 0,
         gpgcheck => 1,
         gpgkey => 'file:///etc/pki/rpm-gpg/RPM-GPG-KEY-OSG',
         failovermethod => 'priority',
  ...
  #       mirrorlist => "http://repo.grid.iu.edu/mirror/3.0/el$lsbmajdistrelease/osg-upcoming-development/\basearch/debug",
            baseurl => "http://repo.grid.iu.edu/3.0/el$lsbmajdistrelease/osg-upcoming-development/\$basearch/debug",
         enabled => 0,
         gpgcheck => 1,
         gpgkey => 'file:///etc/pki/rpm-gpg/RPM-GPG-KEY-OSG',
         failovermethod => 'priority',
  ...
  #       mirrorlist => "http://repo.grid.iu.edu/mirror/3.0/el$lsbmajdistrelease/osg-contrib/\$basearch",
            baseurl => "http://repo.grid.iu.edu/3.0/el$lsbmajdistrelease/osg-contrib/\$basearch",
         enabled => 1,
         gpgcheck => 1,
         gpgkey => 'file:///etc/pki/rpm-gpg/RPM-GPG-KEY-OSG',
         failovermethod => 'priority',
  ...
  #       mirrorlist => "http://repo.grid.iu.edu/mirror/3.0/el$lsbmajdistrelease/osg-contrib/source/SRPMS",
            baseurl => "http://repo.grid.iu.edu/3.0/el$lsbmajdistrelease/osg-contrib/source/SRPMS",
         enabled => 0,
         gpgcheck => 1,
         gpgkey => 'file:///etc/pki/rpm-gpg/RPM-GPG-KEY-OSG',
         failovermethod => 'priority',
  ...
  #       mirrorlist => "http://repo.grid.iu.edu/mirror/3.0/el$lsbmajdistrelease/osg-contrib/\$basearch/debug",
            baseurl => "http://repo.grid.iu.edu/3.0/el$lsbmajdistrelease/osg-contrib/\$basearch/debug",
         enabled => 0,
         gpgcheck => 1,
         gpgkey => 'file:///etc/pki/rpm-gpg/RPM-GPG-KEY-OSG',
         failovermethod => 'priority',
